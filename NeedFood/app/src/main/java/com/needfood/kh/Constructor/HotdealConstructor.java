...
public class HotdealConstructor {
    ...
    public String dv;
    public String mn;
    public String numvote;

    public HotdealConstructor() {
    }

    public HotdealConstructor(String linkimg, String idprd, String idsl, String name, String nameauth, String price, String imga, String price2, String vt, String dv, String mn, String numvote) {
