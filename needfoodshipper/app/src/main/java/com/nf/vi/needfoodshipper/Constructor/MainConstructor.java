...
public class MainConstructor {
    ...
    public MainConstructor(String id, String order, String lc, String ct, String re, String tl, String pay, String moneyship, String stt, String code, String listsanpham) {
        this.id = id;
        this.order = order;
        this.lc = lc;
        this.ct = ct;
